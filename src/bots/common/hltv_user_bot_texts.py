...
BOT_TEXTS = {
    'start': (
        "Привет, {first_name}! 👋\n\n"
        "Я бот для отображению  матчей по CS2.\n\n"
        "Пользуйтесь меню для навигаци\n"
        "/help - Показать справку\n\n"
        "Также вы можете ввести точное название команды (например, 'Natus Vincere' или 'Astralis'), чтобы найти матчик команды.\n"
        "Поиска по сокращенным названиям, пока нет (пр. NAVI, NIP)\n\n"
        "Скоро! Предсказания матчей с помощью нейронных сетей!\n\n"
        "Контакты по всем вопросам: @TarAn0o"
    ),
    'help': (
        "Справка:\n\n"
        "Также вы можете ввести точное название команды (например, 'Natus Vincere' или 'Astralis'), чтобы найти матчик команды.\n"
        "На подробной страницы о будущем матче мы можете подписаться на будущую live-трансляцию матча.\n\n"
        "Контакты по всем вопросам: @TarAn0o"
    ),
    ...
    'back': "Назад",
    'log': {
        'init': "HLTVUserBot initialized ({config_name})",
        'start_command': "{user_info} - /start command invoked",
        'help_command': "{user_info} - /help command invoked",
        'main_menu': "{user_info} - Main menu opened",
        'message': "{user_info} - Message: '{message_text}'",
        'completed_matches_request': "{user_info} - Requested completed matches",
        'upcoming_matches_request': "{user_info} - Requested upcoming matches",
        'today_stats_request': "{user_info} - Requested today's stats",
        'yesterday_stats_request': "{user_info} - Requested yesterday's stats via command",
        'period_matches_request': "{user_info} - Requested matches for period from {start} to {end}",
        'found_matches_period': "{user_info} - Found {count} matches for the specified period",
        'found_matches_today': "{user_info} - Found {count} matches for today",
        'events_list_request': "{user_info} - Requested events list",
        'back_to_menu': "{user_info} - Returned to main menu",
        'match_details_request': "{user_info} - Requested match stats for ID {match_id}",
        'matches_for_event_request': "{user_info} - Requested matches for event ID {event_id}",
